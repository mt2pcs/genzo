...
- 実行は `bash deploy.sh` の1コマンド（gcloud 導入・認証・バケット作成・権限・デプロイ・配信検証まで自己完結）。
  既定: service=genzo, region=asia-northeast1, bucket=love-coach-sprint0-genzo, Basic 認証 genzo/genzo
